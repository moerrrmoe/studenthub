...
export let API_BASE_URL = "https://darkorchid-grouse-741049.hostingersite.com/";
...
export const setApiBaseUrl = async (newUrl) => {
  try {
    if (!newUrl) {
      ...
      API_BASE_URL = process.env.EXPO_PUBLIC_API_URL || "https://darkorchid-grouse-741049.hostingersite.com/";
    } else {
